...
class TestAgent(object):
    ...
    def __init__(
        ...
        self._process = Process(
            target=self._setup, args=(q, self.next_port[0])
        )
        self._process.start()
        self.port = q.get()
    ...
    def _setup(self, q, port):
        ...
        config.addVacmUser(
            snmpEngine, 1, "read-write", "noAuthNoPriv", (1, 3, 6), (1, 3, 6)
        )
        config.addVacmUser(
            snmpEngine, 2, "read-write", "noAuthNoPriv", (1, 3, 6), (1, 3, 6)
        )
        config.addV3User(
            snmpEngine,
            "read-write",
        ...
        config.addVacmUser(
            snmpEngine, 3, "read-write", "authPriv", (1, 3, 6), (1, 3, 6)
        )
        ...
        mibBuilder.exportSymbols(
            ...
            MibScalarInstance(
                ...
                (0,),
                v2c.OctetString(
                    "Snimpy Test Agent {0}".format(self.community)
                ),
            ),
            ...
            MibScalarInstance(
                (1, 3, 6, 1, 2, 1, 1, 2),
                (0,),
                v2c.ObjectIdentifier((1, 3, 6, 1, 4, 1, 9, 1, 1208)),
            ),
        )
        mibBuilder.exportSymbols(
            "__MY_IF_MIB",
            ...
            MibScalarInstance(
                ...
                flatten(2, 6, stringToOid("abcdef")),
                v2c.Integer(1),
            ),
            MibScalarInstance(
                (1, 3, 6, 1, 2, 1, 31, 1, 4, 1, 2),
                flatten(2, 6, stringToOid("ghijkl")),
                v2c.Integer(1),
            ),
            MibScalarInstance(
                (1, 3, 6, 1, 2, 1, 31, 1, 4, 1, 2),
                flatten(3, 6, stringToOid("mnopqr")),
                v2c.Integer(1),
            ),
            ...
            # IF-MIB::ifIndex
            ifIndex=MibTableColumn(
                (1, 3, 6, 1, 2, 1, 2, 2, 1, 1), v2c.Integer()
            ),
            # IF-MIB::ifRcvAddressAddress
            ifRcvAddressAddress=MibTableColumn(
                (1, 3, 6, 1, 2, 1, 31, 1, 4, 1, 1), v2c.OctetString()
            ),
        )
        ...
        args = (
            ...
            MibScalar(
                (1, 3, 6, 1, 2, 1, 45121, 1, 1), v2c.OctetString()
            ).setMaxAccess("readwrite"),
            MibScalarInstance(
                (1, 3, 6, 1, 2, 1, 45121, 1, 1), (0,), v2c.OctetString("AAAA")
            ),
            # SNIMPY-MIB::snimpyString
            MibScalar(
                (1, 3, 6, 1, 2, 1, 45121, 1, 2), v2c.OctetString()
            ).setMaxAccess("readwrite"),
            MibScalarInstance(
            ...
            MibScalar(
                (1, 3, 6, 1, 2, 1, 45121, 1, 3), v2c.Integer()
            ).setMaxAccess("readwrite"),
            MibScalarInstance(
            ...
            MibScalar(
                (1, 3, 6, 1, 2, 1, 45121, 1, 4), v2c.Integer()
            ).setMaxAccess("readwrite"),
            MibScalarInstance(
            ...
            MibScalar(
                (1, 3, 6, 1, 2, 1, 45121, 1, 5), v2c.ObjectIdentifier()
            ).setMaxAccess("readwrite"),
            MibScalarInstance(
                (1, 3, 6, 1, 2, 1, 45121, 1, 5),
                (0,),
                v2c.ObjectIdentifier((1, 3, 6, 4454, 0, 0)),
            ),
            # SNIMPY-MIB::snimpyBoolean
            MibScalar(
                (1, 3, 6, 1, 2, 1, 45121, 1, 6), v2c.Integer()
            ).setMaxAccess("readwrite"),
            MibScalarInstance(
            ...
            MibScalar(
                (1, 3, 6, 1, 2, 1, 45121, 1, 7), v2c.Counter32()
            ).setMaxAccess("readwrite"),
            MibScalarInstance(
            ...
            MibScalar(
                (1, 3, 6, 1, 2, 1, 45121, 1, 8), v2c.Gauge32()
            ).setMaxAccess("readwrite"),
            MibScalarInstance(
            ...
            MibScalar(
                (1, 3, 6, 1, 2, 1, 45121, 1, 9), v2c.TimeTicks()
            ).setMaxAccess("readwrite"),
            MibScalarInstance(
                (1, 3, 6, 1, 2, 1, 45121, 1, 9), (0,), v2c.TimeTicks(12111100)
            ),
            # SNIMPY-MIB::snimpyCounter64
            MibScalar(
                (1, 3, 6, 1, 2, 1, 45121, 1, 10), v2c.Counter64()
            ).setMaxAccess("readwrite"),
            MibScalarInstance(
                (1, 3, 6, 1, 2, 1, 45121, 1, 10),
                (0,),
                v2c.Counter64(2 ** 48 + 3),
            ),
            # SNIMPY-MIB::snimpyBits
            MibScalar(
                (1, 3, 6, 1, 2, 1, 45121, 1, 11), v2c.OctetString()
            ).setMaxAccess("readwrite"),
            MibScalarInstance(
                (1, 3, 6, 1, 2, 1, 45121, 1, 11),
                (0,),
                v2c.OctetString(b"\xa0\x80"),
            ),
            # SNIMPY-MIB::snimpyMacAddress
            MibScalar(
                (1, 3, 6, 1, 2, 1, 45121, 1, 15), v2c.OctetString()
            ).setMaxAccess("readwrite"),
            MibScalarInstance(
                (1, 3, 6, 1, 2, 1, 45121, 1, 15),
                (0,),
                v2c.OctetString(b"\x11\x12\x13\x14\x15\x16"),
            ),
            # SNIMPY-MIB::snimpyMacAddressInvalid
            MibScalar(
                (1, 3, 6, 1, 2, 1, 45121, 1, 16), v2c.OctetString()
            ).setMaxAccess("readwrite"),
            MibScalarInstance(
                (1, 3, 6, 1, 2, 1, 45121, 1, 16),
                (0,),
            ...
            MibTableRow((1, 3, 6, 1, 2, 1, 45121, 2, 7, 1)).setIndexNames(
            ...
            MibScalarInstance(
                ...
                flatten(11, stringToOid("end of row1"), 4),
                v2c.Integer(1785),
            ),
            MibScalarInstance(
                (1, 3, 6, 1, 2, 1, 45121, 2, 7, 1, 1),
                flatten(11, stringToOid("end of row1"), 5),
                v2c.Integer(2458),
            ),
        ...
        if self.emptyTable:
            args += (
                ...
                MibTableRow((1, 3, 6, 1, 2, 1, 45121, 2, 6, 1)).setIndexNames(
        ...
        kwargs = dict(
            ...
            snimpyIndexVarLen=MibTableColumn(
                (1, 3, 6, 1, 2, 1, 45121, 2, 3, 1, 1), v2c.OctetString()
            ),
            snimpyIndexIntIndex=MibTableColumn(
                (1, 3, 6, 1, 2, 1, 45121, 2, 3, 1, 2), v2c.Integer()
            ...
            kwargs.update(
                dict(
                    snimpyEmptyIndex=MibTableColumn(
                        (1, 3, 6, 1, 2, 1, 45121, 2, 6, 1, 1), v2c.Integer()
                    ).setMaxAccess("noaccess"),
